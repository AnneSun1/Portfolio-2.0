...
export default function ProjectsSection() {
  const projects = [
    ...
    //   image: "/estia-preview.webp",
        video: "/estia demo.mp4"
    },
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          <div key={index} className="group">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg overflow-hidden h-full transition-all duration-300 hover:bg-white/10 hover:border-white/20">

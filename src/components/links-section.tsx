...
export default function LinksSection() {
  const links = [
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/sunanne",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Email",
      url: "mailto:anne.sun@uwaterloo.ca",
      icon: (
    ...
    <div className="container mx-auto px-8 py-20 max-w-4xl">
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-light text-white mb-6">
          <span className="font-medium italic instrument">Connect</span> With Me
        </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        {links.map((link, index) => (
          <a
            ...
            className="group flex flex-col items-center p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg transition-all duration-300 hover:bg-white/10 hover:border-white/20 hover:scale-105"
          >
            <div className="text-white/80 group-hover:text-white transition-colors duration-200 mb-3">{link.icon}</div>
